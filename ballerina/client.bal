...
public isolated client class Client {
    ...
    resource isolated function get chat/completions/[string completionId](map<string|string[]> headers = {}) returns CreateChatCompletionResponse|error {
        string resourcePath = string `/chat/completions/${getEncodedUri(completionId)}`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - A chat completion 
    resource isolated function post chat/completions/[string completionId](CompletionscompletionIdBody payload, map<string|string[]> headers = {}) returns CreateChatCompletionResponse|error {
        string resourcePath = string `/chat/completions/${getEncodedUri(completionId)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    resource isolated function delete chat/completions/[string completionId](map<string|string[]> headers = {}) returns ChatCompletionDeleted|error {
        string resourcePath = string `/chat/completions/${getEncodedUri(completionId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    resource isolated function get chat/completions/[string completionId]/messages(map<string|string[]> headers = {}, *GetChatCompletionMessagesQueries queries) returns ChatCompletionMessageList|error {
        string resourcePath = string `/chat/completions/${getEncodedUri(completionId)}/messages`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - A list of evals 
    resource isolated function get evals(map<string|string[]> headers = {}, *ListEvalsQueries queries) returns EvalList|error {
        string resourcePath = string `/evals`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    resource isolated function post evals(CreateEvalRequest payload, map<string|string[]> headers = {}) returns Eval|error {
        string resourcePath = string `/evals`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    resource isolated function get evals/[string evalId](map<string|string[]> headers = {}) returns Eval|error {
        string resourcePath = string `/evals/${getEncodedUri(evalId)}`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + payload - Request to update an evaluation 
    # + return - The updated evaluation 
    resource isolated function post evals/[string evalId](EvalsevalIdBody payload, map<string|string[]> headers = {}) returns Eval|error {
        string resourcePath = string `/evals/${getEncodedUri(evalId)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successfully deleted the evaluation 
    resource isolated function delete evals/[string evalId](map<string|string[]> headers = {}) returns InlineResponse2002|error {
        string resourcePath = string `/evals/${getEncodedUri(evalId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - A list of runs for the evaluation 
    resource isolated function get evals/[string evalId]/runs(map<string|string[]> headers = {}, *GetEvalRunsQueries queries) returns EvalRunList|error {
        string resourcePath = string `/evals/${getEncodedUri(evalId)}/runs`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successfully created a run for the evaluation 
    resource isolated function post evals/[string evalId]/runs(CreateEvalRunRequest payload, map<string|string[]> headers = {}) returns EvalRun|error {
        string resourcePath = string `/evals/${getEncodedUri(evalId)}/runs`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    resource isolated function get evals/[string evalId]/runs/[string runId](map<string|string[]> headers = {}) returns EvalRun|error {
        string resourcePath = string `/evals/${getEncodedUri(evalId)}/runs/${getEncodedUri(runId)}`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - The canceled eval run object 
    resource isolated function post evals/[string evalId]/runs/[string runId](map<string|string[]> headers = {}) returns EvalRun|error {
        string resourcePath = string `/evals/${getEncodedUri(evalId)}/runs/${getEncodedUri(runId)}`;
        http:Request request = new;
        return self.clientEp->post(resourcePath, request, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successfully deleted the eval run 
    resource isolated function delete evals/[string evalId]/runs/[string runId](map<string|string[]> headers = {}) returns InlineResponse2003|error {
        string resourcePath = string `/evals/${getEncodedUri(evalId)}/runs/${getEncodedUri(runId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - A list of output items for the evaluation run 
    resource isolated function get evals/[string evalId]/runs/[string runId]/output_items(map<string|string[]> headers = {}, *GetEvalRunOutputItemsQueries queries) returns EvalRunOutputItemList|error {
        string resourcePath = string `/evals/${getEncodedUri(evalId)}/runs/${getEncodedUri(runId)}/output_items`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - The evaluation run output item 
    resource isolated function get evals/[string evalId]/runs/[string runId]/output_items/[string outputItemId](map<string|string[]> headers = {}) returns EvalRunOutputItem|error {
        string resourcePath = string `/evals/${getEncodedUri(evalId)}/runs/${getEncodedUri(runId)}/output_items/${getEncodedUri(outputItemId)}`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - OK 
    resource isolated function get fine_tuning/checkpoints/[string fineTunedModelCheckpoint]/permissions(map<string|string[]> headers = {}, *ListFineTuningCheckpointPermissionsQueries queries) returns ListFineTuningCheckpointPermissionResponse|error {
        string resourcePath = string `/fine_tuning/checkpoints/${getEncodedUri(fineTunedModelCheckpoint)}/permissions`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    resource isolated function post fine_tuning/checkpoints/[string fineTunedModelCheckpoint]/permissions(CreateFineTuningCheckpointPermissionRequest payload, map<string|string[]> headers = {}) returns ListFineTuningCheckpointPermissionResponse|error {
        string resourcePath = string `/fine_tuning/checkpoints/${getEncodedUri(fineTunedModelCheckpoint)}/permissions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    resource isolated function delete fine_tuning/checkpoints/[string fineTunedModelCheckpoint]/permissions/[string permissionId](map<string|string[]> headers = {}) returns DeleteFineTuningCheckpointPermissionResponse|error {
        string resourcePath = string `/fine_tuning/checkpoints/${getEncodedUri(fineTunedModelCheckpoint)}/permissions/${getEncodedUri(permissionId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - A list of organization API keys 
    resource isolated function get organization/admin_api_keys(map<string|string[]> headers = {}, *AdminApiKeysListQueries queries) returns ApiKeyList|error {
        string resourcePath = string `/organization/admin_api_keys`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    #
    # + headers - Headers to be sent with the request 
    # + return - The newly created admin API key 
    resource isolated function post organization/admin_api_keys(OrganizationAdminApiKeysBody payload, map<string|string[]> headers = {}) returns AdminApiKey|error {
        string resourcePath = string `/organization/admin_api_keys`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    #
    # + headers - Headers to be sent with the request 
    # + return - Details of the requested API key 
    resource isolated function get organization/admin_api_keys/[string keyId](map<string|string[]> headers = {}) returns AdminApiKey|error {
        string resourcePath = string `/organization/admin_api_keys/${getEncodedUri(keyId)}`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    #
    # + headers - Headers to be sent with the request 
    # + return - Confirmation that the API key was deleted 
    resource isolated function delete organization/admin_api_keys/[string keyId](map<string|string[]> headers = {}) returns InlineResponse2004|error {
        string resourcePath = string `/organization/admin_api_keys/${getEncodedUri(keyId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + queries - Queries to be sent with the request 
    # + return - Certificates listed successfully 
    resource isolated function get organization/certificates(map<string|string[]> headers = {}, *ListOrganizationCertificatesQueries queries) returns ListCertificatesResponse|error {
        string resourcePath = string `/organization/certificates`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    #
    # + headers - Headers to be sent with the request 
    # + payload - The certificate upload payload 
    # + return - Certificate uploaded successfully 
    resource isolated function post organization/certificates(UploadCertificateRequest payload, map<string|string[]> headers = {}) returns Certificate|error {
        string resourcePath = string `/organization/certificates`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    #
    # + headers - Headers to be sent with the request 
    # + payload - The certificate activation payload 
    # + return - Certificates activated successfully 
    resource isolated function post organization/certificates/activate(ToggleCertificatesRequest payload, map<string|string[]> headers = {}) returns ListCertificatesResponse|error {
        string resourcePath = string `/organization/certificates/activate`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    #
    # + headers - Headers to be sent with the request 
    # + payload - The certificate deactivation payload 
    # + return - Certificates deactivated successfully 
    resource isolated function post organization/certificates/deactivate(ToggleCertificatesRequest payload, map<string|string[]> headers = {}) returns ListCertificatesResponse|error {
        string resourcePath = string `/organization/certificates/deactivate`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    resource isolated function get organization/certificates/[string certificateId](map<string|string[]> headers = {}, *GetCertificateQueries queries) returns Certificate|error {
        string resourcePath = string `/organization/certificates/${getEncodedUri(certificateId)}`;
    ...
    #
    # + headers - Headers to be sent with the request 
    # + payload - The certificate modification payload 
    # + return - Certificate modified successfully 
    resource isolated function post organization/certificates/[string certificateId](ModifyCertificateRequest payload, map<string|string[]> headers = {}) returns Certificate|error {
        string resourcePath = string `/organization/certificates/${getEncodedUri(certificateId)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    resource isolated function delete organization/certificates/[string certificateId](map<string|string[]> headers = {}) returns DeleteCertificateResponse|error {
        string resourcePath = string `/organization/certificates/${getEncodedUri(certificateId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Certificates listed successfully 
    resource isolated function get organization/projects/[string projectId]/certificates(map<string|string[]> headers = {}, *ListProjectCertificatesQueries queries) returns ListCertificatesResponse|error {
        string resourcePath = string `/organization/projects/${getEncodedUri(projectId)}/certificates`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + payload - The certificate activation payload 
    # + return - Certificates activated successfully 
    resource isolated function post organization/projects/[string projectId]/certificates/activate(ToggleCertificatesRequest payload, map<string|string[]> headers = {}) returns ListCertificatesResponse|error {
        string resourcePath = string `/organization/projects/${getEncodedUri(projectId)}/certificates/activate`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    # + payload - The certificate deactivation payload 
    # + return - Certificates deactivated successfully 
    resource isolated function post organization/projects/[string projectId]/certificates/deactivate(ToggleCertificatesRequest payload, map<string|string[]> headers = {}) returns ListCertificatesResponse|error {
        string resourcePath = string `/organization/projects/${getEncodedUri(projectId)}/certificates/deactivate`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    resource isolated function get organization/users(map<string|string[]> headers = {}, *ListUsersQueries queries) returns UserListResponse|error {
        ...
        map<Encoding> queryParamEncoding = {"emails": {style: FORM, explode: true}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    #
    # + headers - Headers to be sent with the request 
    # + payload - Create an ephemeral API key with the given session configuration 
    # + return - Session created successfully 
    resource isolated function post realtime/sessions(RealtimeSessionCreateRequest payload, map<string|string[]> headers = {}) returns RealtimeSessionCreateResponse|error {
        string resourcePath = string `/realtime/sessions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    # + payload - Create an ephemeral API key with the given session configuration 
    # + return - Session created successfully 
    resource isolated function post realtime/transcription_sessions(RealtimeTranscriptionSessionCreateRequest payload, map<string|string[]> headers = {}) returns RealtimeTranscriptionSessionCreateResponse|error {
        string resourcePath = string `/realtime/transcription_sessions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    # + queries - Queries to be sent with the request 
    # + return - OK 
    resource isolated function get responses/[string responseId](map<string|string[]> headers = {}, *GetResponseQueries queries) returns Response|error {
        string resourcePath = string `/responses/${getEncodedUri(responseId)}`;
        map<Encoding> queryParamEncoding = {"include": {style: FORM, explode: true}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    resource isolated function delete responses/[string responseId](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/responses/${getEncodedUri(responseId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - OK 
    resource isolated function get responses/[string responseId]/input_items(map<string|string[]> headers = {}, *ListInputItemsQueries queries) returns ResponseItemList|error {
        string resourcePath = string `/responses/${getEncodedUri(responseId)}/input_items`;
        map<Encoding> queryParamEncoding = {"include": {style: FORM, explode: true}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    resource isolated function post vector_stores/[string vectorStoreId]/files/[string fileId](UpdateVectorStoreFileAttributesRequest payload, map<string|string[]> headers = {}) returns VectorStoreFileObject|error {
        string resourcePath = string `/vector_stores/${getEncodedUri(vectorStoreId)}/files/${getEncodedUri(fileId)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    resource isolated function get vector_stores/[string vectorStoreId]/files/[string fileId]/content(map<string|string[]> headers = {}) returns VectorStoreFileContentResponse|error {
        string resourcePath = string `/vector_stores/${getEncodedUri(vectorStoreId)}/files/${getEncodedUri(fileId)}/content`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - OK 
    resource isolated function post vector_stores/[string vectorStoreId]/search(VectorStoreSearchRequest payload, map<string|string[]> headers = {}) returns VectorStoreSearchResultsPage|error {
        string resourcePath = string `/vector_stores/${getEncodedUri(vectorStoreId)}/search`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
